...
class QuizBrain {
  ...
  String getQuestionText(int randomNumber) {
    return _questionBank[randomNumber].questionText;
  }

  bool getAnswerText(int randomNumber) {
    return _questionBank[randomNumber].questionAnswer;
  }
}
